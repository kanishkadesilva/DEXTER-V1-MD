...
zokou({ nomCom: "developer", categorie: "General", reaction: "💞" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      { nom: "📌 sahan ", numero: "94720797915" },
      { nom: "📌 kanishka", numero: "94760310266" },
      // Ajoute d'autres développeurs ici avec leur nom et numéro
    ];

    let message = "👋 *Welcome to Sahan-MD* here is the developer contact numbers 👇\n\n";
